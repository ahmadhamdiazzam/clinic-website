...
export default function Home() {
  ...
  const content = {
    en: {
      ...
      accreditationTitle: "Credentials",
      accreditation: ["AO Association Member", "Egyptian Medical Syndicate (Reg. 189769)", "BLS & ACLS Certified (2025)"],
    ...
    ar: {
      ...
      accreditation: ["عضو الجمعية الدولية لتثبيت الكسور (AO)", "عضو نقابة الأطباء المصرية (رقم 189769)", "حاصل على شهادات دعم الحياة الأساسي والمتقدم (2025)"],
